...
use DataGridX\Filters\FilterRow;
use DataGridX\Filters\FilterQuery;
use DataGridX\Columns\ActionColumn;
...
abstract class Grid
{
    ...
    /**
     * Assign to which serial number text
     * @var string
     */
    public $serialNoText = 'Sl.No';
    ...
    public function render()
    {
        ...
        return view('datagridx::grid.index', ['grid' => $this]);
    }
